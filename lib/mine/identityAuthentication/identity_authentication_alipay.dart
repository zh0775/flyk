...
class IdentityAuthenticationAlipayBinding implements Bindings {
  @override
  void dependencies() {
    Get.put<IdentityAuthenticationAlipayController>(IdentityAuthenticationAlipayController());
  }
}
...
class IdentityAuthenticationAlipayController extends GetxController {
  ...
  userAliPayEditRequest(Map<String, dynamic> params, Function(bool success, dynamic json) success) {
    Http().doPost(
      Urls.userAliPayEdit,
      params,
      success: (json) async {
  ...
  submitAction() {
    ...
    simpleRequest(
        ...
        params: {"name": authData["u_Name"] ?? "", "account": accountInputCtrl.text, "u_3nd_Pad": payPassword},
...
class IdentityAuthenticationAlipay extends GetView<IdentityAuthenticationAlipayController> {
  final bool isAdd;
  const IdentityAuthenticationAlipay({Key? key, this.isAdd = true}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
        ...
        child: Scaffold(
          ...
          body: getInputBodyNoBtn(context, buttonHeight: 0, build: (boxHeight, context) {
            return SizedBox(
                width: 375.w,
                height: boxHeight,
                child: SingleChildScrollView(
                  ...
                  ghb(31),
                  GetX<IdentityAuthenticationAlipayController>(builder: (context) {
