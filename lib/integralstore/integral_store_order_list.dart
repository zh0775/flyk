...
import 'package:cxhighversion2/integralstore/integral_store_order_detail.dart';
...
class IntegralStoreOrderListBinding implements Bindings {
  @override
  void dependencies() {
    Get.put<IntegralStoreOrderListController>(
        IntegralStoreOrderListController(datas: Get.arguments));
  }
}

class IntegralStoreOrderListController extends GetxController {
  final dynamic datas;

  IntegralStoreOrderListController({this.datas});
...
class IntegralStoreOrderList extends GetView<IntegralStoreOrderListController> {
  const IntegralStoreOrderList({super.key});
        ...
        children: ["全部", "待发货", "待收货", "已完成"]
            ...
            .map(
              (item) => CustomButton(
                ...
                child: Center(
                  child: GetX<IntegralStoreOrderListController>(
                    init: controller,
                    initState: (_) {},
                    builder: (_) {
                      return SizedBox(
  ...
  Widget mallOrderList(
    ...
    return GetBuilder<IntegralStoreOrderListController>(
