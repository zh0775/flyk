...
class IntegralStoreOrderDetailBinding implements Bindings {
  @override
  void dependencies() {
    Get.put<IntegralStoreOrderDetailController>(
        IntegralStoreOrderDetailController(datas: Get.arguments));
  }
}

class IntegralStoreOrderDetailController extends GetxController {
  final dynamic datas;
  IntegralStoreOrderDetailController({this.datas});
  ...
  prolongAction() {
    simpleRequest(
      url: Urls.orderProlongConfirm(orderData["id"]),
      params: {},
...
class IntegralStoreOrderDetail
    extends GetView<IntegralStoreOrderDetailController> {
  const IntegralStoreOrderDetail({super.key});
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            ...
            GetX<IntegralStoreOrderDetailController>(
              builder: (controller) {
                return Positioned(
                  left: 15.w,
                  top: 220.w, // 下面的margin引起的
                  bottom: controller.haveBtn ? 50.w : 0,
                  child: GetBuilder<IntegralStoreOrderDetailController>(
                    builder: (controller) {
                      return shopOrderBox();
                    },
                  ),
            ...
            GetX<IntegralStoreOrderDetailController>(builder: (_) {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                getWidthText("", 14, AppColor.textGrey, 315 - 50, 3),
              ...
              children: [
                SizedBox(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      getSimpleText('商品总价', 14, AppColor.textGrey),
                      getSimpleText(
                ...
                SizedBox(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      getSimpleText('运费', 14, AppColor.textGrey),
                      getSimpleText('包邮', 14, AppColor.textGrey),
                    ],
                  ),
                ),
                SizedBox(
            ...
            Column(
              children: [
                SizedBox(
                  ...
                  child: Row(
                    children: [
                      getSimpleText('订单编号', 14, AppColor.textGrey),
                      gwb(14.5),
                      getSimpleText(controller.orderData["orderNo"] ?? "", 14,
                          AppColor.textBlack),
                    ],
                  ),
                ),
                SizedBox(
                  ...
                  child: Row(
                    children: [
                      getSimpleText('兑换时间', 14, AppColor.textGrey),
                      gwb(14.5),
                      getSimpleText(controller.orderData["addTime"] ?? "", 14,
                          AppColor.textBlack),
                    ],
                  ),
                ),
                SizedBox(
                  ...
                  child: Row(
                    children: [
                      getSimpleText('订单状态', 14, AppColor.textGrey),
                      gwb(14.5),
                      getSimpleText(controller.orderData["orderStateStr"] ?? "",
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            width: 0.5.w,
            color: type == 0 ? AppColor.textGrey : AppColor.theme,
          ),
        ),
        child: getSimpleText(
