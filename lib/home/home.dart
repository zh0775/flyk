        ...
        children: [
          ...
          sbRow([
            ...
            centClm([
              CustomButton(
                onPressed: () {
                  mine_help_center.loadLibrary().then((value) => push(
                      mine_help_center.MineHelpCenter(), context,
      ...
      child: Column(
        children: [
          cellTitle(
            ...
            rightOnPressed: () {
              business_school_list_page.loadLibrary().then((value) => push(
                  business_school_list_page.BusinessSchoolListPage(), context,
                  binding:
