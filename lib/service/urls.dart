class Urls {
  ...
  static const sendCodeAfterLogin = "/api/Member/SendCode";
  // 注册第一步
...
// /api/UserLogin/AgreementListByID
  static String agreementListByID(int id) => "/api/UserLogin/AgreementListByID/$id";
  // 枚举字典
  ...
  // 用户红包领取所有记录
  static const userHongbaoQueueAllList = "/api/Invest/UserHongbaoQueueAllList";
  // 获取订单记录
  ...
  // 撤单
  static String userInvestOrderCancel(dynamic id) => "/api/Invest/User_InvestOrderCancel/$id";
  // 转换红包信息
  static String redpackConvert(dynamic investConfigId) => "/api/Invest/InvestOrder/$investConfigId";
  // 转红包
  ...
  ////积分商城
  //积分商城首页
  static String userProductHomeInfo(int type) => "/api/Product/User_ProductHomeInfo/$type";
  //商城列表
  ...
  //个人机具列表（高版）
  static const userPersonTerminalHighList = "/api/Terminal/User_PersonTerminal_HighList";
  //待办订单
  static const terminalTransferOrder = "/api/Terminal/User_TerminalTransferOrder";
  //机具划拨
  ...
  //划拨日志记录详情
  static String terminalLogsDetails(dynamic orderNo) => "/api/Terminal/User_TerminalLogsDetails/$orderNo";
  //划拨记录明细
  static String terminalTransferDetail(int id) => "/api/Terminal/User_TerminalDetails/$id";
  //同意划拨
  static String userTerminalTransferConfirm(int id) => "/api/Terminal/User_TerminalTransferConfirm/$id";
  //划拨发货
  static const userTerminalTransferSend = "/api/Terminal/User_TerminalTransferSend";
  //修改划拨状态
  static String userTerminalTransferStatus(int id, int status) => "/api/Terminal/User_TerminalTransferStatus/$id/$status";
  ...
  //获取 费率模板下拉列表
  static const getSelectToolMarginTemplateList = "/api/SensitiveSelect/GetSelectToolMarginTemplateList";
  //机具信息
  static String userTerminalInfo(int tId) => "/api/Terminal/User_TerminalInfo/$tId";
  ...
  //商学院详情
  static String userBusinessSchoolShow(int id) => "/api/New/User_BusinessSchoolShow/$id";
  //收藏
  static String userShareCollection({required dynamic id, required dynamic type}) => "/api/BuyMember/User_ShareCollection/$id/$type";
  //取消收藏
  static String userDelShareCollection(int id) => "/api/BuyMember/User_DelShareCollection/$id";
  //收藏列表
  static const userShareCollectionList = "/api/BuyMember/User_ShareCollectionList";
  ...
  ////采购
  //商城详情
  static String userLevelGiftTeamDetail(int id) => "api/LevelGift/User_LevelGiftTeamDetail/$id";
  ...
  //分润等级详情
  static const userShareProfitLevelInfoData = "/api/UserLevel/User_ShareProfitLevelInfoData";
  //分润统计枚举字典
  ...
  //商城订单确认收货
  static String userOrderConfirm(dynamic id) => "/api/Order/User_OrderConfirm/$id";
  ...
  //商城订单 验证订单
  static String userOrderVerifi(dynamic orderNO) => "/api/BuyMember/VerifiOrderStatus/2/$orderNO";
  //商城订单 交易类型
  static const getTradeDataConfigList = "/api/SensitiveSelect/GetTradeDataConfigList/0/1";
  //商城订单 状态枚举
  ...
  //礼包订单列表
  static const userLevelGiftOrderList = "/api/LevelGift/User_LevelGiftOrderList";
  static String userLevelGiftOrderShow(int id) => "/api/LevelGift/User_LevelGiftOrderShow/$id";

  //礼包订单 去支付
  static String userPayGiftOrder(dynamic id) => "/api/LevelGift/User_PayOrder/$id";

  //礼包订单 取消订单
  static String userLevelGiftOrderCancel(dynamic id) => "/api/LevelGift/User_LevelGiftOrderCancel/$id";

  //礼包订单 确认收货
  static String userLevelGiftOrderConfirm(dynamic id) => "/api/LevelGift/User_LevelGiftOrderConfirm/$id";

  //礼包订单 删除订单
  static String userLevelGiftDelOrder(dynamic id) => "/api/LevelGift/User_LevelGiftDelOrder/$id";

  //礼包订单 商城详情
  static String userLevelGiftShow(dynamic id) => "/api/LevelGift/User_LevelGiftShow/$id";

  //礼包订单 验证订单
  static String userGiftOrderVerifi(dynamic orderNO) => "/api/BuyMember/VerifiOrderStatus/1/$orderNO";
  ...
  //钱包流水
  static const userFinanceIntegralList = "/api/Finance/User_FinanceIntegralList";
  ...
  //批量回拨机具
  static String userTerminalCallBack(String tids) => "/api/Terminal/User_TerminalCallBack/$tids";
  //获取机具操作日志
  static const userTerminalLogsList = "/api/Terminal/User_TerminalLogsList";
  //获取机具操作日志详情
  static String userTerminalLogsDetails(String orderNO) => "/api/Terminal/User_TerminalLogsDetails/$orderNO";

  ////我的商户
  //获取商户品质列表----搜索条件
  static const userMerchantStatusSearch = "/api/Merchant/UserMerchantStatusSearch";
  //商户状态统计
  ...
  //查看商户详情
  static String userMerchantShow(dynamic tId) => "/api/Merchant/User_MerchantDetail_High/$tId";
  ...
  ////收益
  //收益奖
  static String userBounsDetailEarn(dynamic type) => "/api/Finance/User_BounsDetail/$type";
  //收益流水
  static const userFinanceList = "/api/Finance/User_BounsList";
  //收益详情
  static String userFinanceSourceShow(dynamic id, dynamic sources) => "/api/Finance/User_FinanceSourceShow/$id/$sources";
  //收益详情(按日，月，年 分组统计)
  ...
  //业绩详情(按日，月，年 分组统计)
  static const userPerformanceDetailList = "/api/UserTeam/User_PerformanceDetailList";
  ...
  //获取外部注册信息
  static const getAPPExternalRegInfo = "/api/UserLogin/User_GetAPPExternalRegInfo";
  //检查银行卡号，银行识别
  ...
  //通过代理申请
  static String userFeaturesPass(dynamic id) => "/api/FeaturesApply/User_FeaturesPass/$id";
  //拒绝代理申请
  static String userFeaturesRefuse(dynamic id) => "/api/FeaturesApply/User_FeaturesRefuse/$id";

  //永久拒绝代理申请
  static String userFeaturesOverRefuse(dynamic id) => "/api/FeaturesApply/User_FeaturesOverRefuse/$id";
  //撤回永久拒绝
  static String userFeaturesWithdraw(dynamic id) => "/api/FeaturesApply/User_FeaturesWithdraw/$id";
  ...
  // 设备订单
  // 设备推广
  static const levelGiftPromotionList = "/api/LevelGift/User_LevelGiftPromotionList";
  // 设置推广设备
  static const levelGiftPromotionSet = "/api/LevelGift/User_LevelGiftPromotionSet";

  //设备订单 作废订单
  static String userLevelGiftOrderInvalid(dynamic id) => "/api/LevelGift/User_LevelGiftOrderInvalid/$id";

  //设备订单 确认收款
  static String userLevelGiftOrderCheckPay(dynamic id) => "/api/LevelGift/User_LevelGiftOrderCheckPay/$id";

  //设备订单 卖家作废售后申请
  static String userLevelUpAfterSaleDestroy(dynamic id) => "/api/LevelGift/User_LevelUpAfterSaleDestroy/$id";

  //设备订单 买家撤回售后申请
  static String userLevelUpAfterSaleCancel(dynamic id) => "/api/LevelGift/User_LevelUpAfterSaleCancel/$id";

  //设备订单 卖家发货
  static const userLevelUpOrderConfirm = "/api/LevelGift/User_LevelUpOrderConfirm";

  //设备订单 卖家售后发货
  static const userLevelUpAfterSaleShipments = "/api/LevelGift/User_LevelUpAfterSaleShipments";

  //设备订单 选择退货设备
  static String returnTerminalList(dynamic id) => "/api/LevelGift/User_ReturnTerminal_List/$id";

  //设备订单 申请售后
  static const userLevelUpAfterSaleApply = "/api/LevelGift/User_LevelUpAfterSaleApply";

  //设备订单 卖家同意售后
  static const userLevelUpAfterSaleConfirm = "/api/LevelGift/User_LevelUpAfterSaleConfirm";
  //设备订单 售后订单详情
  static String userLevelGiftAfterSaleShow(dynamic id) => "/api/LevelGift/User_LevelGiftAfterSaleShow/$id";

  //设备订单 买家寄回商品
  static const userLevelUpAfterSaleReturn = "/api/LevelGift/User_LevelUpAfterSaleReturn";

  //设备订单 上级 售后确认回收
  static String userLevelUpAfterSaleRecycle(dynamic id) => "/api/LevelGift/User_LevelUpAfterSaleRecycle/$id";

  //维修工单
  static const userFeaturesApplyList = "/api/FeaturesApply/User_FeaturesApplyList";

  //新建维修工单
  static const userMaintaineApply = "/api/FeaturesApply/User_MaintaineApply";

  //维修工单 作废、取消
  static String featuresOverRefuse(dynamic id) => "/api/FeaturesApply/User_FeaturesOverRefuse/$id";

  //维修工单 申请通过
  static const userMaintainePass = "/api/FeaturesApply/User_MaintainePass";

  //维修工单 驳回
  static String featuresWithdraw(dynamic id) => "/api/FeaturesApply/User_FeaturesWithdraw/$id";

  //续货管理
  static const userTerminalFreightList = "/api/Terminal/User_TerminalFreightList";

  //在线客服 新建工单
  static const userCustomerServiceApply = "/api/FeaturesApply/User_CustomerServiceApply";

  //在线客服 客服工单
  static const userCustomerServiceList = "/api/FeaturesApply/UserCustomerServiceList";

  //权益设备 我的关联权益设备
  static const userTerminalAssociateList = "/api/Terminal/User_TerminalAssociateList";

  //权益设备 我的置换设备
  static const userTerminalReplaceList = "/api/Terminal/User_Terminal_ReplaceList";

  //权益设备 换机记录
  static const userTerminalAssociateLogsList = "/api/Terminal/User_TerminalAssociateLogsList";

  //权益设备 切换权益设备
  static const userTerminalAssociateSwitch = "/api/Terminal/User_TerminalAssociateSwitch";

  //权益设备 关联权益设备
  static const userTerminalAssociate = "/api/Terminal/User_TerminalAssociate";

  //权益设备 关联权益设备
  static const userTerminalAssociate2 = "/api/Terminal/User_TerminalAssociate2";

  //统计 合伙人、盘主管理
  static const userTeamByLeaderList = "/api/UserTeam/User_TeamByLeaderList";

  //统计 合伙人、盘主管理 列表展开信息
  static String userTeamByLeaderShow(dynamic userId) => "/api/UserTeam/User_TeamByLeaderShow/$userId";

  //统计 合伙人、盘主管理 库存信息
  static String userTeamByInventoryShow(dynamic userId) => "/api/UserTeam/User_TeamByInventoryShow/$userId";

  //统计 设备统计
  static const userTerminalStatisticsList = "/api/Statistics/User_TerminalStatisticsList";

  //统计 交易统计
  static const userTransactionStatisticsList = "/api/Statistics/User_TransactionStatisticsList";

  //统计 收益统计
  static const userIncomeStatisticsList = "/api/Statistics/User_IncomeStatisticsList";

  //统计 积分统计
  static const userIntegralStatisticsList = "/api/Statistics/User_IntegralStatisticsList";
  ...
  //奖金池 领取奖励
  static const userVirtualCoinOrderOnSell = "/api/VirtualCoin/User_VirtualCoinOrderOnSell";
  ...
  //积分复购支付订单列表
  static const userIntegralRepurchaseList = "/api/Draw/User_IntegralRepurchaseList";

  //积分复购 取消
  static String userIntegralRepurchaseRefuse(dynamic id) => "/api/Draw/UserIntegralRepurchaseRefuse/$id";

  //积分复购 去支付
  static String userIntegralRepurchasePay(dynamic id) => "/api/Draw/UserIntegralRepurchasePay/$id";
  ...
  //金融区
  //信用卡银行资源
  static const userCreditCardBankList = "/api/CreditCard/User_CreditCardBankList";

  //贷款资源
  static const userCreditCardLoansList = "/api/CreditCard/User_CreditCardLoansList";
  ...
  //申请贷款
  static const userCreditCardLoansAdd = "/api/CreditCard/UserCreditCardLoansAdd";

  //申请信用卡订单
  static const userCreditCardOrderList = "/api/CreditCard/User_CreditCardOrderList";

  //申请贷款订单
  static const userCreditCardLoansOrderList = "/api/CreditCard/User_CreditCardLoansOrderList";

  //申请贷款订单
  static String ruleDescriptionByID(dynamic type) => "/api/BuyMember/RuleDescriptionByID/$type";
...
//积分商城
//添加收藏
  static String userAddProductCollection(dynamic id, dynamic type) => "/api/Product/User_AddProductCollection/$id/$type";
  // 删除收藏
  static String userDeleteCollection(dynamic collectionIds) => "/api/Product/User_DeleteCollectionByProductId/$collectionIds";

  //我的评价/待评价 /api/Product/User_MyCommentList
  static const userMyCommentList = "/api/Product/User_MyCommentList";

  // 我要评价
  static const userCommentAdd = "/api/Product/User_CommentAdd";
  ...
  // 朋友消息-消息通知
  static const userFriendLogList = "/api/New/User_FriendLogList";

  // 续货管理详情
  static const userTerminalFreightShow = "/api/Terminal/User_TerminalFreightShow";
  ...
  /// 权益设备 换机记录
  static const userTerminalAssociateLogs = "/api/Terminal/User_TerminalAssociateLogs";

  /// 获取市区
  static String getArea(dynamic type, dynamic code) => "/api/Member/GetArea/$type/$code";

  // 创业支持
  static const getSupport = '/api/CrediTticket/User_CrediTticketList';

  // 确认兑换
  static const exchangeVoucher = '/api/CrediTticket/User_CrediTticketConfirm';

  // 申请记录
  static const applyExchangeRecord = '/api/CrediTticket/User_CrediTticketOrderList';

  /// 收入-奖励汇总
  static const userBounsNameByCount = '/api/Finance/User_BounsNameByCount';

  /// 读取商户编辑资料
  static String userMerchantEditShow(dynamic id) => '/api/Merchant/UserMerchantEditShow/$id';
}
